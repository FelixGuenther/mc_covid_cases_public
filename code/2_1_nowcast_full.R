...
load(paste0("../results/nowcast_bav/imp_dat_synth.RData"))

nc_res = estimate_nowcasts(imputed_data = imputed_data, 
                           data_date = data_date, 
                           save_results = FALSE, safePredictLag = 2)
nc_smry = nc_res$nc_smry
save(nc_smry, file = "../results/nowcast_bav/nowcast_synth.RData")
rt_1 = estimate_Rt(nc_res, data_date = data_date)
save(rt_1, file = "../results/nowcast_bav/rt_1_synth.RData")
quit(save = "no")